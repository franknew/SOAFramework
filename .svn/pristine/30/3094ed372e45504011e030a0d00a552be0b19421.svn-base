...
namespace Frank.Common.DAL
{
    class OracleHelper : DBHelper
    {
        ...
        private OleDbCommand mObj_Command = new OleDbCommand();
        #endregion

        #region constructor
        public OracleHelper(string strConnectionString)
        {
        ...
        /// <param name="objParams">objects</param>
        ...
        public DataTable GetTableWithSQL(string strCommandString, Parameter[] objParams, string strConnectionString, int intStartIndex, int intEndIndex, string strIDColumnName)
        {
            ...
            {
                objCommand.Parameters.AddRange(Parameter.ChangeToOleParameters(objParams));
            }
        ...
        {
            return GetTableWithSQL(strCommandString, objParams, "", intStartIndex, intEndIndex, strIDColumnName);
        }
        ...
        {
            return GetTableWithSQL(strCommandString, null, "", intStartIndex, intEndIndex, strIDColumnName);
        }
        ...
        {
            return GetTableWithSQL(strCommandString, null, strCommandString, 0, 0, "");
        }
        #endregion
        ...
        {
            return GetDataSetWithSQL(strCommandString, objParams, "", intStartIndex, intEndIndex, strIDColumnName);
        }

        public DataSet GetDataSetWithSQL(string strCommandString, Parameter[] objParams, string strConnectionString)
        {
            return GetDataSetWithSQL(strCommandString, objParams, strCommandString, 0, 0, "");
        }
        ...
        {
            return GetDataSetWithSQL(strCommandString, null, "", intStartIndex, intEndIndex, strIDColumnName);
        }
