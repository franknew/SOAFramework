...
namespace SOAFramework.WebServiceCore
{
    ...
    public class ClientRequest
    {
        ...
        private string mStr_CallMethodName = "CallMethod";
        ...
        public string GetRequestString()
        {
            ...
            strEncodedRequest = System.Web.HttpUtility.UrlEncode(strRequest);
            return strEncodedRequest;
        }
        /// <summary>
        /// 发送请求到服务器端
        /// </summary>
        ...
        {
            ClientRequest crRequest = JSONUtil.JSONDeserialize<ClientRequest>(JSON);
            return crRequest;
        }
        #endregion
