namespace Athena.Unitop.Sure.Lib.RazorEngine.Configuration.Xml
{
    using System;
    ...
    using Athena.Unitop.Sure.Lib.RazorEngine;
    using Athena.Unitop.Sure.Lib.RazorEngine.Inspectors;
    using Templating;
    using Text;
    using Athena.Unitop.Sure.Lib.RazorEngine.Configuration.Xml;
    ...
    public class XmlTemplateServiceConfiguration : ITemplateServiceConfiguration
    {
        ...
        private void InitialiseConfiguration(string name)
        {
            ...
            if (config == null)
                throw new ConfigurationErrorsException("No <Athena.Unitop.Sure.Lib.RazorEngine> configuration section has been defined.");
