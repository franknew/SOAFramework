namespace Athena.Unitop.Sure.Lib.RazorEngine.Configuration
{
    ...
    /// <summary>
    /// Defines the main configuration section for the Athena.Unitop.Sure.Lib.RazorEngine.
    /// </summary>
    public class RazorEngineConfigurationSection : ConfigurationSection
    {
        ...
        private const string SectionPath = "Athena.Unitop.Sure.Lib.RazorEngine";
