...
namespace Athena.Unitop.Sure.Lib.Validator
{
    ...
    public static class Validation
    {
        ...
        {
            return !Regex.IsMatch(evalString, RegularExpressions.ALPHA);
        }
        ...
        {
            return !Regex.IsMatch(evalString, RegularExpressions.ALPHA_NUMERIC);
        }
        ...
        {
            if (allowSpaces)
                return !Regex.IsMatch(evalString, RegularExpressions.ALPHA_NUMERIC_SPACE);
        ...
        {
            return !Regex.IsMatch(evalString, RegularExpressions.NUMERIC);
        }
        ...
        {
            return Regex.IsMatch(emailAddressString, RegularExpressions.EMAIL);
        }
        ...
        {
            return Regex.IsMatch(inputString, RegularExpressions.LOWER_CASE);
        }
        ...
        {
            return Regex.IsMatch(inputString, RegularExpressions.UPPER_CASE);
        }
        ...
        {
            return Regex.IsMatch(guid, RegularExpressions.GUID);
        }
        ...
        {
            return Regex.IsMatch(zipCode, RegularExpressions.US_ZIPCODE_PLUS_FOUR_OPTIONAL);
        }
        ...
        {
            return Regex.IsMatch(zipCode, RegularExpressions.US_ZIPCODE);
        }
        ...
        {
            return Regex.IsMatch(zipCode, RegularExpressions.US_ZIPCODE_PLUS_FOUR);
        }
        ...
        {
            return Regex.IsMatch(socialSecurityNumber, RegularExpressions.SOCIAL_SECURITY);
        }
        ...
        {
            return Regex.IsMatch(ipAddress, RegularExpressions.IP_ADDRESS);
        }
        ...
        {
            return Regex.IsMatch(telephoneNumber, RegularExpressions.US_TELEPHONE);
        }
        ...
        {
            return Regex.IsMatch(currency, RegularExpressions.US_CURRENCY);
        }
        ...
        {
            return Regex.IsMatch(url, RegularExpressions.URL);
        }
        ...
        {
            return Regex.IsMatch(password, RegularExpressions.STRONG_PASSWORD);
        }
        ...
        public static bool IsCreditCardAny(this string creditCard)
        {
            if (CreditPassesFormatCheck(creditCard))
            {
                ...
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_AMERICAN_EXPRESS) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_CARTE_BLANCHE) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_DINERS_CLUB) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_DISCOVER) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_EN_ROUTE) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_JCB) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_MASTER_CARD) ||
                       Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_VISA);
            }
            return false;
        }
        ...
        public static bool IsCreditCardCarteBlanche(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_CARTE_BLANCHE);
            }
            return false;
        }
        ...
        public static bool IsCreditCardDinersClub(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_DINERS_CLUB);
            }
            return false;
        }
        ...
        public static bool IsCreditCardDiscover(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_DISCOVER);
            }
            return false;
        }
        ...
        public static bool IsCreditCardEnRoute(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_EN_ROUTE);
            }
            return false;
        }
        ...
        public static bool IsCreditCardJCB(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_JCB);
            }
            return false;
        }
        ...
        public static bool IsCreditCardMasterCard(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_MASTER_CARD);
            }
            return false;
        }
        ...
        public static bool IsCreditCardVisa(this string creditCard)
        {
            ...
            {
                creditCard = CleanCreditCardNumber(creditCard);
                return Regex.IsMatch(creditCard, RegularExpressions.CREDIT_CARD_VISA);
            }
            return false;
        }
        ...
        {
            Regex regex = new Regex(RegularExpressions.CREDIT_CARD_STRIP_NON_NUMERIC, RegexOptions.IgnoreCase | RegexOptions.Singleline);
