namespace SOAFramework.Library.RazorEngine
{
    using System;
    ...
    using SOAFramework.Library.RazorEngine.Compilation;
    ...
    public abstract class CompilerServiceBase : MarshalByRefObject, ICompilerService
    {
        ...
        private SOAFramework.Library.RazorEngine.Compilation.RazorEngineHost CreateHost(Type templateType, Type modelType, string className)
        {
            var host = new SOAFramework.Library.RazorEngine.Compilation.RazorEngineHost(CodeLanguage, MarkupParserFactory)
                           {
                               ...
                               GeneratedClassContext = new GeneratedClassContext("Execute", "Write", "WriteLiteral",
                                                                                 ...
                                                                                 "SOAFramework.Library.RazorEngine.Templating.TemplateWriter",
                                                                                 "DefineSection") {
