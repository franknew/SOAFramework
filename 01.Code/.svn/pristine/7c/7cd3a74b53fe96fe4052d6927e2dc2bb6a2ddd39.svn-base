namespace SOAFramework.Library.RazorEngine.Configuration.Xml
{
    using System;
    ...
    using SOAFramework.Library.RazorEngine.Inspectors;
    using Templating;
    using Text;
    using SOAFramework.Library.RazorEngine.Configuration.Xml;
    ...
    public class XmlTemplateServiceConfiguration : ITemplateServiceConfiguration
    {
        ...
        private void InitialiseConfiguration(string name)
        {
            ...
            if (config == null)
                throw new ConfigurationErrorsException("No <SOAFramework.Library.RazorEngine> configuration section has been defined.");
