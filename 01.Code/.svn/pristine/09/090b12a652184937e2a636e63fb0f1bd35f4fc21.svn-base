...
namespace SOAFramework.Library.RazorEngine.CSharp
{
    ...
    public class CSharpRazorCodeGenerator : System.Web.Razor.Generator.CSharpRazorCodeGenerator
    {
        ...
        private void SetBaseTypeFromHost(SOAFramework.Library.RazorEngine.Compilation.RazorEngineHost mvcHost)
        {
