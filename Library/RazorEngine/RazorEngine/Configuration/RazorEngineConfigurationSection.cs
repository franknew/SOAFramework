namespace SOAFramework.Library.RazorEngine.Configuration
{
    ...
    /// <summary>
    /// Defines the main configuration section for the SOAFramework.Library.RazorEngine.
    /// </summary>
    public class RazorEngineConfigurationSection : ConfigurationSection
    {
        ...
        private const string SectionPath = "SOAFramework.Library.RazorEngine";
